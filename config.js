    ...
    /* 
        ...
        Modal_Style = 7; New WalletConnect v3
    ...
    */
        ...
        const Popup_dark_mode = true; // "true = dark" & "false = light"
    
        const modal_div_config = {
            "modal_dark_mode": true // "true = dark" & "false = light"
        };
        ...
        const Modal2_Subtitle_URL = "";
        const Modal2_Subtitle_URL_Text = "";
        ...
        const WalletConnect_v3_dark = true; // "true = dark" & "false = light"
